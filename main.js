window.onload = function(){
  ...
  document.getElementById('submit-btn').addEventListener('click', function(ev){
    ...
    if (topic.value === "beer") {
      var query = 'https://api.meetup.com/2/open_events?key=1153924241c41273b2d4b4f235e1d13&sign=true&zip=' + userInput.value + '&topic=beer&time=,1w';
      console.log('beer dawg');

    } if (topic.value === "photo") {
        var query = 'https://api.meetup.com/2/open_events?key=1153924241c41273b2d4b4f235e1d13&sign=true&zip=' + userInput.value + '&topic=photo&time=,1w';
        console.log('photo dawg');

    } if (topic.value === "music") {
        var query = 'https://api.meetup.com/2/open_events?key=1153924241c41273b2d4b4f235e1d13&sign=true&zip=' + userInput.value + '&topic=music&time=,1w';
    ...
    //  console.log(compiledHtml);
      ...
      console.log("wtf you thinking, son??");
    }); //end fail
